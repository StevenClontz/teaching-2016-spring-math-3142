...
\chapter{The Euclidean Space \texorpdfstring{$\mb R^n$}{R\^n}}


\section{The Linear Structure of \texorpdfstring{$\mb R^n$}{R\^n}
...
\section{Convergence of Sequences in \texorpdfstring{$\mb R^n$}{R\^n}}
...
\section{Open Sets and Closed Sets in \texorpdfstring{$\mb R^n$}{R\^n}}
